    ...
    <>
      ...
      <div ref={homePage} id='homePage' className="page row">
        <div className="col-lg-6 d-flex flex-column justify-content-center gap-5">
          ...
          <span>
            <p className='largeText'>Hello, I am Jarno de Coninck a software developer!</p>
            <p>I am 19 years old, and I was born in Knokke. One of my strengths is that I always keep my code neat and organized. I am also very creative. I am currently studying software development in college to improve my programming skills. My hobbies include making games and going to the gym, and one of my main ambitions is to become a professional software developer.</p>
          </span>
